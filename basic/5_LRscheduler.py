...
class LogTypeScheduler(LRScheduler):
    def __init__(self, optimizer, start_lr=0.03, end_lr=5e-4, epochs=50, last_epoch=-1, **kwargs):
        ...
        super(LogTypeScheduler, self).__init__(optimizer, last_epoch)


class StepTypeScheduler(LRScheduler):
    def __init__(self, optimizer, start_lr=0.01, end_lr=None, step=10, mult=0.1, epochs=50, last_epoch=-1, **kwargs):
        ...
        super(StepTypeScheduler, self).__init__(optimizer, last_epoch)


class MultiStepTypeScheduler(LRScheduler):
    def __init__(self, optimizer, start_lr=0.01, end_lr=None, steps=[10,20,30,40], mult=0.5, epochs=50, last_epoch=-1, **kwargs):
        ...
        super(MultiStepTypeScheduler, self).__init__(optimizer, last_epoch)
...
class LinearTypeStepScheduler(LRScheduler):
    def __init__(self, optimizer, start_lr=0.01, end_lr=0.005, epochs=50, last_epoch=-1, **kwargs):
        ...
        super(LinearTypeStepScheduler, self).__init__(optimizer, last_epoch)


class CosTypeStepScheduler(LRScheduler):
    def __init__(self, optimizer, start_lr=0.01, end_lr=0.005, epochs=50, last_epoch=-1, **kwargs):
        self.start_lr = start_lr
        self.end_lr = end_lr
        self.lr_spaces = self._build_lr(start_lr, end_lr, epochs)

        super(CosTypeStepScheduler, self).__init__(optimizer, last_epoch)
...
class WarmUpStratergy(LRScheduler):
    def __init__(self, optimizer, warmup, normal, epochs=50, last_epoch=-1):
        ...
        super(WarmUpStratergy, self).__init__(optimizer, last_epoch)


LRTypes = {
    'log': LogTypeScheduler,
    'step': StepTypeScheduler,
    'multi-step': MultiStepTypeScheduler,
    'linear': LinearTypeStepScheduler,
    'cos': CosTypeStepScheduler
          }
...
def _build_lr_scheduler(optimizer, cfg, epochs=50, last_epoch=-1):
    ...
    if cfg['type'] not in LRTypes:
        raise Exception('Unknown type of LR Scheduler "%s"'%cfg['type'])

    return LRTypes[cfg['type']](optimizer, last_epoch=last_epoch, epochs=epochs, **cfg)
...
def _build_warm_up_scheduler(optimizer, cfg, epochs=50, last_epoch=-1):
    ...
    return WarmUpStratergy(optimizer, sc1, sc2, epochs, last_epoch)
